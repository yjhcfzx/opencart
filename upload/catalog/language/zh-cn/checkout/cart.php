...
// Text
$_['text_success']             = '您已成功新增商品<a href="%s">%s</a> 到您的 <a href="%s">购物车</a>！';
$_['text_remove']              = '您已成功更新了购物车！';
$_['text_login']               = '警告： 您必须<a href="%s">登录</a> 或 <a href="%s">注册新帐户</a> 后才能显示单价！';
$_['text_items']               = '%s 个商品 - %s';
$_['text_points']              = '积点： %s';
$_['text_next']                = '下一步您想要做什么？';
$_['text_next_choice']         = '选择使用优惠券，或使用积点折扣，或预估运费';
$_['text_empty']               = '您的购物车内没有任何商品！';
$_['text_day']                 = '每天';
$_['text_week']                = '每周';
