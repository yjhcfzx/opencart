...
$_['text_account']       = '帐号';
$_['text_return']        = '退换货资料';
$_['text_return_detail'] = '退换货明细';
$_['text_description']   = '<p>请填写下表以取得 RMA 号码。</p>';
$_['text_order']         = '订单资料';
$_['text_product']       = '商品资料';
$_['text_reason']        = '退换货原因';
$_['text_message']       = '<p>您的商品退换请求已经发送到相关部门处理。</p><p> 我们将通过 Email 邮件通知您退换货的作业进度。</p>';
...
// Error
$_['text_error']         = '找不到您查询的退换记录。';
$_['error_order_id']     = '请输入订单编号。';
$_['error_firstname']    = '名字必须在 1 到 32 个字之间。';
$_['error_lastname']     = '姓氏必须在 1 到 32 个字之间。';
$_['error_email']        = '无效的 Email 信箱。';
$_['error_telephone']    = '电话号码必须是 3 到 32 个字之间。';
$_['error_product']      = '商品名称必须在 3 到 255 个字之间。';
$_['error_model']        = '商品型号必须在 3 到 64 个字之间。';
