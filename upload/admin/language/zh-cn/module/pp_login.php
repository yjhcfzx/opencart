<?php
// Heading
$_['heading_title']        = '使用 PayPal 帐户名登录';

//Text
$_['text_module']          = '模块管理';
$_['text_success']         = '成功：您已修改用 PayPal 帐户名登录！';
$_['text_edit']            = '编辑用PayPal帐户名登录';
...
$_['entry_sandbox']        = '沙盒模式';
$_['entry_debug']          = '除错日志';
$_['entry_customer_group'] = '客户群组';
$_['entry_button']         = '按钮颜色';
$_['entry_seamless']       = '允许「Seamless Checkout」';
$_['entry_locale']         = 'Locale';
$_['entry_return_url']     = '返回URL';
$_['entry_status']         = '状态';
...
$_['error_client_id']      = 'Client ID 必须输入 !';
$_['error_secret']         = '密钥必须输入 !';